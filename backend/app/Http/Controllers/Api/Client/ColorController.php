...
class ColorController extends Controller
{
    ...
    public function getSavedColors(Request $request): JsonResponse
    {
        try {
            ...
            $query = ClientSavedColor::forUser($user->id)
    ...
    public function getColor($id): JsonResponse
    {
        try {
            ...
            $color = ClientSavedColor::forUser($user->id)->find($id);
    ...
    public function getColorStats(): JsonResponse
    {
        try {
            ...
            $stats = ClientSavedColor::forUser($user->id)
                ->select(
            ...
            // Get color family distribution
            $familyDistribution = ClientSavedColor::forUser($user->id)
            ...
            return response()->json([
                ...
                'data' => [
                    ...
                    'recent_colors' => ClientSavedColor::forUser($user->id)->recent(5)->get()
                ]
            ]);
