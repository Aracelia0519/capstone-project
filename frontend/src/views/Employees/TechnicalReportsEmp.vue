      ...
      <div v-if="activeTab === 'create'" class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
            ...
            <transition name="fade-slide" mode="out-in">
                <div v-if="currentStep === 1" class="space-y-6 max-w-2xl mx-auto">
                    <div>
                        ...
                        <p class="text-sm text-slate-600 mb-6">Help us understand what kind of problem you're facing in the Employee Hub.</p>
                    </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                <select v-model="form.category" class="w-full bg-white border border-slate-300 text-slate-900 rounded-xl px-4 py-3 pr-10 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all appearance-none">
                                    ...
                                    <option value="payment_issue">Payroll / Payment Issue</option>
        ...
        <div class="px-6 py-4 bg-slate-50 border-t border-slate-200 flex items-center justify-between">
            ...
            <button 
                ...
                class="px-8 py-2.5 rounded-xl font-bold transition-all flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-blue-500/20"
            >
            ...
            <button 
                ...
                class="px-8 py-2.5 rounded-xl font-black transition-all flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white disabled:opacity-50 shadow-md shadow-emerald-500/20"
            >
...
const submitReport = async () => {
    ...
    try {
        ...
        const response = await api.post('/employee/technical-reports', formData, {
...
const fetchMyReports = async () => {
    ...
    try {
        const response = await api.get('/employee/technical-reports')
        if (response.data.success) {
