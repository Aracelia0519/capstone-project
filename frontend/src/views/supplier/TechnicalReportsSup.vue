            ...
            <transition name="fade-slide" mode="out-in">
                <div v-if="currentStep === 1" class="space-y-6 max-w-2xl mx-auto">
                    <div>
                        ...
                        <p class="text-sm text-slate-600 mb-6">Help us understand what kind of problem you're facing in the Supplier Hub.</p>
                    </div>
...
const submitReport = async () => {
    ...
    try {
        ...
        const response = await api.post('/supplier/technical-reports', formData, {
...
const fetchMyReports = async () => {
    ...
    try {
        const response = await api.get('/supplier/technical-reports')
        if (response.data.success) {
