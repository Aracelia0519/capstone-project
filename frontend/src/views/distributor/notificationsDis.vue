          ...
          >
            ...
            <div class="flex-1 space-y-2 min-w-0">
              ...
              <div v-if="notification.attachment || notification.attachment_url" 
                   ...
                   class="mt-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white dark:bg-slate-900 text-xs font-bold text-indigo-600 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-900 shadow-sm transition-transform group-hover:scale-105 cursor-pointer hover:bg-indigo-50">
