    ...
    <div class="mb-6 md:mb-8">
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p class="text-gray-600 mt-2">Monitor and analyze your distributor business performance</p>
        </div>
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <div class="flex items-center mt-2">
                    ...
                    <span class="text-xs opacity-90">{{ monthlySummary.revenueGrowth }}% vs prev. period</span>
                  </div>
                </div>
            ...
            <CardContent class="p-5">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-xs opacity-90 mt-2">items/gallons</p>
                </div>
                <div class="p-3 bg-white/20 rounded-xl backdrop-blur-sm">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <div class="flex items-center mt-2">
                    ...
                    <span class="text-xs opacity-90">{{ monthlySummary.orderGrowth }}% vs prev. period</span>
                  </div>
                </div>
                <div class="p-3 bg-white/20 rounded-xl backdrop-blur-sm">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Card class="border-gray-200 shadow-sm">
            <CardContent class="p-4 sm:p-6">
              ...
              <div class="space-y-4">
                  ...
                  <div class="flex-1 min-w-0">
                    <div class="flex items-start justify-between gap-2">
                      ...
                      <div class="text-right flex-shrink-0">
                        ...
                        <p class="text-xs sm:text-sm text-gray-500">{{ product.quantity }} items</p>
                      </div>
                    </div>
                ...
                <div v-if="topSellingPaints.length === 0" class="text-center py-6 text-gray-500">
              ...
              <div class="mt-6 pt-4 border-t border-gray-100 grid grid-cols-2 gap-4">
                ...
                <div>
                  <p class="text-xs text-gray-500">Avg. Price/Item</p>
            ...
            <div v-for="item in filteredStockMovement" :key="item.id" class="p-4">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p class="font-bold text-gray-900">{{ item.currentStock }} items</p>
                </div>
                <div>
                  <p class="text-xs text-gray-500">Min. Required</p>
                  <p class="font-medium text-gray-900">{{ item.minRequired }} items</p>
                </div>
              </div>
              ...
              <div class="mt-4 pt-3 border-t border-gray-100">
                ...
                <div class="flex items-center justify-between flex-wrap gap-2">
                  ...
                  <span class="text-sm text-gray-500">{{ item.lastMovement.quantity }} items</span>
          ...
          <div class="hidden md:block overflow-x-auto">
            <Table>
              <TableHeader class="bg-gray-50">
                <TableRow>
                  <TableHead class="py-3.5 px-6 text-xs font-semibold text-gray-700 uppercase tracking-wider">Product</TableHead>
              ...
              <TableBody class="divide-y divide-gray-200">
                <TableRow v-for="item in filteredStockMovement" :key="item.id" class="hover:bg-gray-50 transition-colors">
                  ...
                  <TableCell class="py-4 px-6">
                    <div class="font-medium text-gray-900">{{ item.minRequired }} items</div>
                  ...
                  <TableCell class="py-4 px-6">
                    <div>
                      ...
                      <div class="text-sm text-gray-500">{{ item.lastMovement.quantity }} items</div>
          ...
          <CardContent class="p-6">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                ...
                <p class="opacity-90 max-w-2xl">This combined report provides a comprehensive overview of your business performance for {{ selectedPeriod.label.toLowerCase() }}. Key insights include revenue, product stock tracking, and active employee metrics.</p>
              </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6 pt-6 border-t border-white/20">
              <div class="bg-white/5 p-4 rounded-lg">
                ...
                <p class="text-sm opacity-90">Revenue is at {{ monthlySummary.revenueGrowth }}% compared to the previous period.</p>
              </div>
              ...
              <div class="bg-white/5 p-4 rounded-lg">
                ...
                <p class="text-sm opacity-90" v-if="topSellingPaints.length > 0">{{ topSellingPaints[0].name }} led sales with ₱{{ formatCurrency(topSellingPaints[0].revenue) }}.</p>
                <p class="text-sm opacity-90" v-else>No products sold in this period.</p>
              </div>
              ...
              <div class="bg-white/5 p-4 rounded-lg">
                <div class="flex items-center gap-3 mb-2">
                  ...
                  <h3 class="font-semibold">HR Active Summary</h3>
                </div>
                <p class="text-sm opacity-90">{{ hrSummary.totalEmployees }} Total Employees. {{ hrSummary.activeAttendances }} attendance logs for this period.</p>
              </div>
            </div>
          </CardContent>
        </Card>
...
export default {
  ...
  computed: {
    maxRevenue() {
      ...
      return Math.max(...this.monthlyChartData.map(m => m.revenue), 1)
    },
    minRevenue() {
    ...
    linePoints() {
      if (this.maxRevenue === 0) return []
      const width = 400
      const height = 200
      const points = this.monthlyChartData.map((month, index) => {
        const x = (index / (Math.max(this.monthlyChartData.length - 1, 1))) * width
        const range = this.maxRevenue - this.minRevenue || 1
        const y = height - ((month.revenue - this.minRevenue) / range) * height
        return { x, y }
      })
      return points
    },
