        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          ...
          <div class="relative">
            <button @click="toggleDatePicker"
              ...
              <span class="text-sm font-medium">{{ selectedDateRange }}</span>
            ...
            <div v-if="showDatePicker" class="absolute top-full mt-1 left-0 w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-10 p-3">
              <div class="space-y-2">
                <button v-for="range in dateRanges" 
                        ...
                        :class="{'bg-blue-50 text-blue-600': selectedDateRangeValue === range.value}">
                  {{ range.label }}
                </button>
              </div>
            </div>
          ...
          <button @click="exportData"
                  class="flex items-center justify-center gap-2 px-4 py-2.5 bg-green-50 text-green-700 border border-green-200 rounded-lg hover:bg-green-100 transition-colors">
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="relative">
              <input type="text" 
                     ...
                     class="pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg w-full sm:w-64 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
      ...
      <div class="hidden md:block overflow-x-auto">
        <table class="w-full">
          <thead class="bg-gray-50">
            <tr>
              <th class="py-3.5 px-6 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                <div class="flex items-center gap-2">
              ...
              <th class="py-3.5 px-6 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Quantity</th>
              <th class="py-3.5 px-6 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Service Provider</th>
              <th class="py-3.5 px-6 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Client</th>
              <th class="py-3.5 px-6 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Amount</th>
              <th class="py-3.5 px-6 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Actions</th>
            </tr>
          </thead>
            ...
            <tr v-for="sale in paginatedSales" :key="sale.id" class="hover:bg-gray-50 transition-colors">
              ...
              <td class="py-4 px-6">
                <div class="flex items-center gap-1">
                  ...
                  <button @click="printInvoice(sale)"
                  ...
                  <button @click="duplicateTransaction(sale)"
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="flex items-center gap-1">
          <button v-for="page in visiblePages" 
                  ...
                  :class="page === currentPage ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-100'">
            {{ page }}
          </button>
        </div>
        <button @click="nextPage" :disabled="currentPage * itemsPerPage >= filteredSales.length" 
                class="p-2 rounded-lg border border-gray-300 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default {
  ...
  methods: {
    ...
    selectDateRange(range) {
      this.selectedDateRangeValue = range
