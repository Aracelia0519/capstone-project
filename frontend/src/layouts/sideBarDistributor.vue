  ...
  >
    ...
    <div class="sidebar-header">
      <div class="flex items-center space-x-4">
        ...
        <div class="relative">
          <div class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-400 via-purple-400 to-pink-300 flex items-center justify-center shadow-2xl animate-pulse-slow">
