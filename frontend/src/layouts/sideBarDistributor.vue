      ...
      <div class="nav-section">
        ...
        <ul class="nav-list">
          ...
          <li>
            <router-link 
              v-if="isVerified"
              to="/distributor/OperationalDistributorD"
              @click="handleNavigation"
              class="nav-item group"
              active-class="nav-item-active"
            >
              <div class="nav-icon-wrapper">
                <div class="nav-icon bg-gradient-to-r from-indigo-500 to-blue-500">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                  </svg>
                </div>
                <span v-if="!isCollapsed || isMobile" class="nav-text">Operational Distributors</span>
              </div>
              <div v-if="!isCollapsed || isMobile" class="nav-badge bg-indigo-500/20 text-indigo-300">
                {{ operationalDistributorsCount || stats?.operationalDistributors || 0 }}
              </div>
            </router-link>
            <div v-else @click="openVerificationModal" class="nav-item group cursor-not-allowed opacity-60">
              <div class="nav-icon-wrapper">
          ...
          <li>
            ...
            >
              <div class="nav-icon-wrapper">
                ...
                <span v-if="!isCollapsed || isMobile" class="nav-text">HR Managers</span>
              </div>
              <div v-if="!isCollapsed || isMobile" class="nav-badge bg-green-500/20 text-green-300">{{ stats.hrManagers }}</div>
            </router-link>
            <div v-else @click="openVerificationModal" class="nav-item group cursor-not-allowed opacity-60">
              <div class="nav-icon-wrapper">
                <div class="nav-icon bg-gradient-to-r from-gray-400 to-gray-300">
          ...
          <li>
            <router-link 
              v-if="isVerified"
              to="/distributor/FinanceManagerD"
              @click="handleNavigation"
              class="nav-item group"
              active-class="nav-item-active"
            >
              <div class="nav-icon-wrapper">
                <div class="nav-icon bg-gradient-to-r from-purple-500 to-purple-400">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <span v-if="!isCollapsed || isMobile" class="nav-text">Finance Managers</span>
              </div>
              <div v-if="!isCollapsed || isMobile" class="nav-badge bg-purple-500/20 text-purple-300">{{ stats.financeManagers || 0 }}</div>
            </router-link>
            <div v-else @click="openVerificationModal" class="nav-item group cursor-not-allowed opacity-60">
              <div class="nav-icon-wrapper">
                <div class="nav-icon bg-gradient-to-r from-gray-400 to-gray-300">
